...
In the first project, I build a basic server application and render the client data from the server side. Also, used REST Client for Client Emulation.
...
In the third and last project, I am learning how to use Prisma ORM for PostgreSQL queries and finally try to dockerize the project successfully to Docker.